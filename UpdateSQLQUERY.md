...
ALTER TABLE notifications
  ...
  ADD COLUMN IF NOT EXISTS delivery_channel VARCHAR(50) DEFAULT 'database';

-- Step 2: Set default value for existing rows where status is NULL
...
CREATE INDEX IF NOT EXISTS notifications_type
  ON notifications(notification_type);

CREATE INDEX IF NOT EXISTS notifications_entity
