...
import { createCashierPayment, updateCashierPaymentStatus, getPrimaryImageUrl } from './service';
...
export default function CashierPOSPage() {
  ...
  const handleCheckout = async () => {
    ...
    if (newOrderId) {
      ...
      const { data: paymentData, error: paymentError } = await createCashierPayment(
        newOrderId,
        'cash',
        total,
        user?.id
