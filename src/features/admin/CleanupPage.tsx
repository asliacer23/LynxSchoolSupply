    ...
    <div className="container py-8">
      <div className="max-w-2xl">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage old audit logs and notifications</p>
        </div>
            ...
            {!stats ? (
              ...
              <>
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-gray-600">Audit logs (older than 30 days)</p>
                    <p className="text-2xl font-bold">{stats.auditLogsOlderThan30Days}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Notifications (older than 90 days)</p>
                    <p className="text-2xl font-bold">{stats.notificationsOlderThan90Days}</p>
                  </div>
                </div>
                <div>
                  <p className="text-sm text-gray-600">Read notifications (older than 30 days)</p>
